...
import edu.aku.hassannaqvi.smk_pwd.databinding.ActivitySectionF9Binding;
...
public class SectionF9Activity extends AppCompatActivity {

    ActivitySectionF9Binding bi;
    ...
    private void SaveDraft() throws JSONException {
        ...
        json.put("fi01", bi.fi01a.isChecked() ? "1"
                : bi.fi01b.isChecked() ? "2"
                :  "-1");

        json.put("fi02", bi.fi02a.isChecked() ? "1"
                : bi.fi02b.isChecked() ? "2"
                :  "-1");
    ...
    public void BtnContinue() {
        ...
        if (UpdateDB()) {
            finish();
            startActivity(new Intent(this, SectionF10Activity.class));
        }
    }
