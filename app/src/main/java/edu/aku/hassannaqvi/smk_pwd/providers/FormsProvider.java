  ...
  */
 package edu.aku.hassannaqvi.smk_pwd.providers;
 ...
 public class FormsProvider extends ContentProvider {
     ...
     private static UriMatcher buildUriMatcher() {
         ...
         matcher.addURI(authority, FormsContract.FormsTable.PATH, FORMS);
         matcher.addURI(authority, FormsContract.FormsTable.PATH + "/*", FORMS_WITH_CHILDREN);
         matcher.addURI(authority, FormsContract.FormsTable.PATH + "/*/*", FORMS_WITH_CHILDREN_AND_DATE);
